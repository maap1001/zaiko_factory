...
let dataTableOptions = {
    ...
    columnDefs: [
        ...
        { searchable: true, targets: '_all' }, // Deshabilitar o habilitar búsqueda en todas las columnas
        { width: '5%', targets: '_all' }, 
        { className: 'text-left', targets: '_all' }  // Aplicar un ancho del 5% a todas las columnas
